    ...
    public void copyFromClipData(
        ...
        try {
            ...
            if(bundle == null){
                ...
                boolean containsKey = bundle.containsKey(SRC_PARENT_KEY);
                if(!containsKey){
                    bundle.putString(SRC_PARENT_KEY, "content://com.android.externalstorage.documents/document/primary:Desktop");
                }
            }
            String srcParentString = bundle.getString(SRC_PARENT_KEY);
            Log.i(TAG,"bundle srcParentString "+srcParentString);
